...
public class RentalMapper {
	...
	public static RentalTO mapToRentalTO(RentalEntity rentalEntity) {
		...
		RentalTO rentalTO = RentalTO.builder()
				.id(rentalEntity.getId())
				.startDatetime(rentalEntity.getStartDatetime())
				.endDatetime(rentalEntity.getEndDatetime())
				.loanAmount(rentalEntity.getLoanAmount())
				.clientId(rentalEntity.getClient().getId())
				.carId(rentalEntity.getCar().getId())
				.pickUpOfficeId(rentalEntity.getId())
				.returnOfficeId(rentalEntity.getId())
				.build();
	...
	public static RentalEntity mapToRentalEntity(RentalTOWithEntities rentalTOWithEntities) {
		...
		RentalEntity rentalEntity = RentalEntity.builder()
				.id(rentalTOWithEntities.getRentalTO().getId())
				...
				.loanAmount(rentalTOWithEntities.getRentalTO().getLoanAmount())
				.client(rentalTOWithEntities.getClient())
				.car(rentalTOWithEntities.getCar())
				.pickUpOffice(rentalTOWithEntities.getPickUpOffice())
				.returnOffice(rentalTOWithEntities.getReturnOffice())
				.build();
